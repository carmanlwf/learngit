...
namespace Ims.Card.Model
{
  ...
  /// <summary>
    ...
    /// </summary>
    [Serializable]
    [DbObject("card_chargelist", ObjType = DbObjectAttribute.ObjectType.Table)]
    [DbObject("v_card_chargelist", ObjType = DbObjectAttribute.ObjectType.View)]
    [DbObject("v_card_chargelistInfo", ObjType = DbObjectAttribute.ObjectType.View)]
    [BindControlParameter("", "value", ParamUsage = BindParameterUsage.OpInsert | BindParameterUsage.OpQuery | BindParameterUsage.OpUpdate | BindParameterUsage.BindToObjectAndParameter)]
    public class card_chargelist
    {
