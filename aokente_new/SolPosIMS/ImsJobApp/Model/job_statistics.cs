...
namespace Ims.Job.Model
{
    ...
    public class job_statistics
    {
       ...
       // y.operatorid,y.name,x.ReturnMoney,x.amount_real,x.amount_receivable,x.giving_amount,
        ...
        private bool _isSignleOrMutiply;
        /// <summary>
        /// 是否根据人员编号的单数或复数查询
        /// </summary>
        public bool isSignleOrMutiply
        {
            get { return _isSignleOrMutiply; }
            set { _isSignleOrMutiply = value; }
        }
    }

    public class job_statistics_p
    {
        private string _operatorid;
        /// <summary>
        /// 收费员编号
        ...
        public string receivable
        {
            get
            {
                if (string.IsNullOrEmpty(_receivable))
                    return "0.00";
                else
                    return _receivable;
            }
        ...
        public string pledge
        {
            get
            {
                if (string.IsNullOrEmpty(_pledge))
                    return "0.00";
                else
                    return _pledge;
            }
        ...
        public string unpaid
        {
            get
            {
                if (string.IsNullOrEmpty(_unpaid))
                    return "0";
                else
                    return _unpaid;
            }
        ...
        private string _wirelessRecharge;
        /// <summary>
        /// 无线充值总额
        /// </summary>
        public string wirelessRecharge
        {
            get
            {
                if (string.IsNullOrEmpty(_wirelessRecharge))
                    return "0.00";
                else
                    return _wirelessRecharge;
            }
            set { _wirelessRecharge = value; }
        }

        private string _rebates;
        /// <summary>
        /// 返回押金总额
        /// </summary>
        public string rebates
        {
            get
            {
                if (string.IsNullOrEmpty(_rebates))
                    return "0.00";
                else
                    return _rebates;
            }
        ...
        public string afterPayment
        {
            get
            {
                if (string.IsNullOrEmpty(_afterPayment))
                    return "0.00";
                else
                    return _afterPayment;
            }

            set { _afterPayment = value; }
        }

        private string _carCount;
        /// <summary>
        /// 进场车辆总数
        /// </summary>
        public string carCount
        {
            get
            {
                if (string.IsNullOrEmpty(_carCount))
                    return "0.00";
                else
                    return _carCount;
            }
        ...
        private string _officialReceipts;
        /// <summary>
        /// 实收金额总额
        /// </summary>
        public string officialReceipts
        {
            get
            {
                if (string.IsNullOrEmpty(_officialReceipts))
                    return "0.00";
                else
                    return _officialReceipts;
            }
