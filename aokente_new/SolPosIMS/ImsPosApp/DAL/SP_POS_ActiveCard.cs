...
{
    public class SP_POS_ActiveCard
    {
        /// <summary>
        /// 结算
        /// </summary>
        ...
        public static DataSet POS_ActiveCard(SP_POS_ALLParams o)
        {
            SqlParameter[] Para = new SqlParameter[]{                
                   new SqlParameter("@PosSnr", SqlDbType.VarChar,20), 
                   new SqlParameter("@CardSnr", SqlDbType.VarChar,20),   
                   new SqlParameter("@Name",SqlDbType.BigInt,20),
                   new SqlParameter("@Mobile",SqlDbType.VarChar,50),                  
                   new SqlParameter("@ReMessage",SqlDbType.Int,4),
            ...
            {
                //o.USERID = Convert.ToDecimal(Para[7].Value);
            }
