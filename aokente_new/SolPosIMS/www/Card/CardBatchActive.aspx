<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CardBatchActive.aspx.cs" Inherits="Card_CardBatchActive"  StylesheetTheme="app"%>
			...
			<table>
				<tbody>
                    ...
                    <tr>
						...
						<td class="xyfmr">1、批量操作会占用服务器的资源,同时防止操作失误,建议每次激活卡张数不超过1000张,最多为999张<br />
