<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetAmount.aspx.cs" Inherits="Card_SetAmount" %>
...
<script type="text/javascript" language ="javascript">
    function checkInput() {
        var num_begin = document.getElementById('beginAmount').value; //起始金额
        var num_end = document.getElementById('endAmount').value; //结束金额
        var num_actual = document.getElementById('actualMoney').value; //起赠金额
          ...
          <table cellpadding="1" cellspacing="1" class="table_default table_blue" 
              ...
              <tr>
                  <th class="style6">
                      规则名称</th>
                  <td class="style5">
                      <input id="bounsname" runat="server" class="inputblue" maxlength="18" 
                          name="bounsname" style="width: 285px"
              ...
              <tr>
                  <th class="style7">
                      起始金额</th>
                  <td>
                      <input id="beginAmount" runat="server" class="inputblue" maxlength="10" name="beginAmount"
                          style="width: 285px; background-color: #C0C0C0;" type="text" vdisp="起始金额" 
                          vmode="not null" readonly="readonly" /></td>
              </tr>
              <tr>
                  <th class="style6">
                      截至金额</th>
                  <td class="style5">
                      <input id="endAmount" runat="server" class="inputblue" maxlength="10" name="endAmount"
                          style="width: 285px; background-color: #C0C0C0;" type="text" vdisp="截至金额" vtype="float" 
                          vmode="not null" readonly="readonly" /></td>
              </tr>
              <tr>
                  <th class="style6">
                      起赠金额</th>
                  <td class="style5">
                      <input id="actualMoney" runat="server" class="inputblue" maxlength="10" name="actualMoney"
                          style="width: 285px" type="text" vdisp="起赠金额" vtype="float" 
                          vmode="not null" /></td>
              </tr>
              <tr>
                  <th class="style6">
                      赠送金额</th>
                  <td class="style5">
                      <input id="giftMoney" runat="server" class="inputblue" maxlength="10" name="giftMoney"
                          style="width: 285px" type="text" vdisp="赠送金额" vtype="float" 
                          vmode="not null" /></td>
              </tr>
              <tr>
                  <th class="style6">
...
<div class="appsection">
  <div style="width:100%; text-align: right;" align="center">
      &nbsp;<input type="button" id="btnInsert" onclick="if(!doAllMessageBoxValidate(form1)||!checkInput()) return false;" runat="server" value="提交" class="xybtn" onserverclick="btnInsert_Click" />&nbsp;
