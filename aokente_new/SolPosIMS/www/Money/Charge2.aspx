<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Charge2.aspx.cs" Inherits="Money_Charge2" %>
...
WaitHelper.showWaitMessage();
  ...
  <input id="btnJieGua0" runat="server" class="btn001" name="btnJieGua0"  onserverclick="Button1_Click"
            type="button" value="读 卡" /></td>
            </tr>
            <tr>
                <th class="style13">
