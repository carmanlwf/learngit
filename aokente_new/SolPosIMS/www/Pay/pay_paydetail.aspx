<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pay_paydetail.aspx.cs" Inherits="Pay_pay_paydetail"  StylesheetTheme="app" %>
                ...
                <tr>
                    ...
                    <td class="style6">
                        <input type="text" class="inputblue" style="width: 130px" id="businessid" runat="server"
                            name="businessid" maxlength="30" /></td>
                    <th class="style6">
                        交易类型</th>
                    <td class="style6">
