<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_CarInParkList.aspx.cs" Inherits="Report_Rpt_CarInParkList" StylesheetTheme="app"%>
            ...
            <table cellpadding="1" cellspacing="1" class="table_default table_blue" id="TABLE1" runat="server" style="width:100%">
                ...
                <tr>
                    <th class="style6">
                        进场时间</th>
                    <td class="style6">
                        <input type="text" class="inputblue" style="width: 132px" id="start_date_begin" runat="server" onfocus="setdatetime(this)" vdisp="起始时间" vtype="datetime" name="start_date_begin" maxlength="20" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})" />～<input type="text" class="inputblue" style="width: 132px" id="start_date_end"
