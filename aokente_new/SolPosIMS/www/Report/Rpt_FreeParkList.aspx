<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_FreeParkList.aspx.cs" Inherits="Report_Rpt_FreeParkList" StylesheetTheme="app" %>
            ...
            <table cellpadding="1" cellspacing="1" class="table_default table_blue" id="TABLE1" runat="server" style="width:100%">
                ...
                <tr>
                    ...
                    <td class="style6">
                             ...
                             <div class="inline layinput"  style=" float:left; margin-left:20px; border:1px solid #B8E1F6; width:142px; height:25px;"><input placeholder="YYYY-MM-DD hh:mm:ss"  runat="server"  id="start_date_begin" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})" style="  font-size:12px; width:133px;" /></div><span style=" float:left; color:Red; font-size:16px;">～</span>
                            <div class="inline layinput"  style="float:left;margin-left:1px; border:1px solid #B8E1F6; width:142px; height:25px;"><input placeholder="YYYY-MM-DD hh:mm:ss"  runat="server"  id="start_date_end" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})"  style="  font-size:12px; width:133px;"/></div>
                            </td>
                    <th class="style6">
                        离场时间</th>
                    <td class="style6">
                     
                             <div class="inline layinput"  style=" float:left; margin-left:20px; border:1px solid #B8E1F6; width:152px; height:25px;"><input placeholder="YYYY-MM-DD hh:mm:ss"  runat="server"  id="end_date_begin" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})" style="  font-size:11px; width:133px;" /></div><span style=" float:left; color:Red; font-size:16px;">～</span>
                            <div class="inline layinput"  style="float:left;margin-left:1px; border:1px solid #B8E1F6; width:155px; height:25px;"><input placeholder="YYYY-MM-DD hh:mm:ss"  runat="server"  id="end_date_end" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})"  style="  font-size:11px; width:133px;"/></div>
