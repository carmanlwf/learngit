<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_PosUser.aspx.cs" Inherits="Report_Rpt_PosUser"
    StylesheetTheme="app" %>
...
<body style="width: 98%;">
    ...
    <ul class="sitemappath">
        <li><strong>操作员记录信息</strong></li></ul>
    ...
    <div class="appsection" id="search_result" runat="server">
        ...
        <asp:GridView Width="100%" PageSize="30" ID="GridView1" runat="server" SkinID="GridView_Blue"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="pageSize"
        OnSelecting="ObjectDataSource1_Selecting" SelectCountMethod="GetPagedObject_count"
        SelectMethod="GetPagedObject" SortParameterName="sortedBy" StartRowIndexParameterName="startIndex"
        TypeName="Ims.Card.BLL.CardChargeListBLL" 
