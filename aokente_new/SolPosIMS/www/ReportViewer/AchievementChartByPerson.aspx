<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AchievementChartByPerson.aspx.cs" Inherits="ReportViewer_AchievementChartByPerson"  StylesheetTheme="app"%>
                    ...
                    <td align="right" style="height: 18px; text-align: left;">
                        <div id ="SearchPannel" >
                          <div class="inline layinput"  style="float:left;margin-left:1px; border:1px solid #B8E1F6; width:155px; height:25px;"><input placeholder="YYYY-MM-DD hh:mm:ss"  runat="server"  id="addeddate_begin" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})"  style="  font-size:12px; width:130px;"/></div><span style=" float:left; color:Red; font-size:16px;">~</span>
                            ...
                            <input id="Button1" type="submit" value="查 询" runat="server"  style=" margin-left:20px; width: 72px;" onclick="if(!doAllMessageBoxValidate(form1)) return false;"/>
                    </div></td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td>
                        <asp:Chart ID="Chart1" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="receivable" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                    ...
                    <td>
                        <asp:Chart ID="Chart2" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="pledge" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
                ...
                <tr>
                    <td>
                        <asp:Chart ID="Chart3" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="unpaid" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
                    ...
                    <td>
                        <asp:Chart ID="Chart4" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="wirelessRecharge" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
                ...
                <tr>
                    <td>
                        <asp:Chart ID="Chart5" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="rebates" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
                    ...
                    <td>
                        <asp:Chart ID="Chart6" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="afterPayment" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
                ...
                <tr>
                    <td>
                        <asp:Chart ID="Chart7" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="carCount" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
                    ...
                    <td>
                        <asp:Chart ID="Chart8" runat="server" DataSourceID="ObjectDataSource1" Width="500px" CssClass="left">
                            ...
                            <series>
                                <asp:Series Name="Series1" XValueMember="name" YValueMembers="officialReceipts" IsValueShownAsLabel="True" ChartType="Pie" Label="#PERCENT{P1}（#VAL 元）">
                                </asp:Series>
                            </series>
                            <chartareas>
                                <asp:ChartArea Name="ChartArea1">
