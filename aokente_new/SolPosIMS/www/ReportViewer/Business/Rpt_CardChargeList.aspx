<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_CardChargeList.aspx.cs" Inherits="ReportViewer_Business_Rpt_CardChargeList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>充值记录清单报表</title>
...
<body>
    ...
    <table cellpadding="1" cellspacing="1" class="table_blue" 
        ...
        <tr>
            ...
            <td>
     &nbsp;<input type="button" id="btnSubmit" runat="server"
                    value="执行导出" class="xybtn" name="btnSubmit" 
                    onserverclick="btnSubmit_ServerClick" onclick="return btnSubmit_onclick()" /><a href="../RptList.aspx" target="_self">返回列表<img src="../../images/back.png" style="border:0;" /></a></td>
        </tr>
    </table>
