<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_MemberCardList.aspx.cs" Inherits="ReportViewer_Business_Rpt_MemberCardList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>会员信息清单报表</title>
        ...
        style="width: 100%; ">
         <tr>
            <th>
                机器编号</th>
            <td>
                 <input type="text" class="inputblue" style="width:120px" id="possnr"  
         ...
         <tr>
            ...
            <td>
                 <asp:DropDownList ID="Area_Code" runat="server" Width="120px" 
                            AutoPostBack="True" 
                     onselectedindexchanged="Area_Code_SelectedIndexChanged" CssClass="inputblue">
                        </asp:DropDownList>
        ...
        <tr>
                    ...
                    <td class="style6">
                        <input type="text" class="inputblue" style="width: 130px" id="start_date_begin"
                            ...
                            maxlength="20" />～<input type="text" class="inputblue" style="width: 130px" id="start_date_end"
                                runat="server" onfocus="setdatetime(this)" vdisp="截止时间" 
                            vtype="datetime" name="start_date_end"
                                maxlength="20" /><input id="cbToday_in" name="cbToday_in"  runat="server"
                   ...
                   <th class="style6">
                    ...
                    <td class="styl6">
                        <input type="text" class="inputblue" style="width: 130px" id="end_date_begin"
                            ...
                            maxlength="20" />～<input type="text" class="inputblue" style="width: 130px" id="end_date_end"
                                runat="server" onfocus="setdatetime(this)" vdisp="截止时间" 
                            vtype="datetime" name="end_date_end"
                                maxlength="20" /><input id="cbToday_out" runat="server" 
