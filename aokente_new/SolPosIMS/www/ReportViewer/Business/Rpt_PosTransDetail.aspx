<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_PosTransDetail.aspx.cs" Inherits="ReportViewer_Business_Rpt_PosTransDetail" %>
...
<%--jquery引用--%>
    ...
    <script type="text/javascript">
        ...
        $(function() {
           ...
           // $("#Area_Code").ligerComboBox({ width: 150});   //下拉列表控件
           // $("#Site_Code").ligerComboBox({ width: 150});   //下拉列表控件
        });
    </script>
        <script type="text/javascript">
    ...
    <table cellpadding="1" cellspacing="1" class="table_blue" 
        ...
        <tr>
            <th>
                交易批次号</th>
            <td>
         <input type="text" class="inputblue" style="width: 120px" id="BatchSnr" runat="server"
                            name="BatchSnr" vtype="number" maxlength="10" /></td>
        </tr>
        <tr>
            <th>
                交易卡号</th>
            <td>
                        <input type="text" class="inputblue" style="width: 120px" id="Magcard" runat="server"
                            name="Magcard1" maxlength="20" /></td>
        </tr>
        <tr>
            <th>
                终端机号(设备号)</th>
            <td>
                        <input type="text" class="inputblue" style="width: 120px" id="PosSnr" runat="server"
