<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_SiteCount.aspx.cs" Inherits="ReportViewer_Business_Rpt_SiteCount" %>
    ...
    <table cellpadding="1" cellspacing="1" class="table_blue" 
        ...
        <tr>
            <th>
                分店名称</th>
            <td>
		  <input type="text" class="inputblue" style="width:120px" id="sitename"  
                runat="server" maxlength="30" name="sitename" /></td>
        </tr>
        <tr>
            <th>
                分店编号</th>
            <td>
                 <input type="text" class="inputblue" style="width:120px" id="id"  runat="server" maxlength="20" /></td>
        </tr>
        <tr>
            <th>
                机器编号</th>
