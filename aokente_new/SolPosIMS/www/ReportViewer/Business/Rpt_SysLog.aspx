<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_SysLog.aspx.cs" Inherits="ReportViewer_Business_Rpt_SysLog" %>
    ...
    <table cellpadding="1" cellspacing="1" class="table_blue" 
        ...
        <tr>
            <th>
                操作员号</th>
            <td>
                <input type="text" class="inputblue" style="width:120px" id="operater"  runat="server" name="operater" maxlength="25" /></td>
        </tr>
        <tr>
            <th>
                日志类型</th>
            <td>
                <select class="inputblue" style="width:120px" id="type" runat="server" name="type">
                </select></td>
        </tr>
        <tr>
            <th>
