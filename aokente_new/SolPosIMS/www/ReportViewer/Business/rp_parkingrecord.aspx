<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rp_parkingrecord.aspx.cs" Inherits="ReportViewer_Business_rp_parkingrecord" %>
    ...
    <table cellpadding="1" cellspacing="1" class="table_blue" 
        style="width: 100%; ">
         <tr>
            <th class="style29">
                终端设备号</th>
            <td class="style29">
                 <input type="text" class="inputblue" style="width:130px" id="possnr"  
                     runat="server" maxlength="20" name="possnr" /></td>
        </tr>
        <tr>
                    <th class="style29">
                        车牌号</th>
         ...
         <tr>
                   <th class="style29">
                        进场/离场</th>
                    <td class="style29">
                        <select id="Mode" runat="server" class="inputblue" name="Mode" 
                            style="width: 130px">
                        </select></td>
         </tr>
         <tr>
        ...
        <tr>
                    <th class="style29">
                        进场时间</th>
                    <td class="style29">
                        <input type="text" class="inputblue" style="width: 130px" id="start_date_begin"
                            runat="server" onfocus="setdatetime(this)" vdisp="起始时间" vtype="datetime" name="start_date_begin"
                            maxlength="20" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})" />～<input type="text" class="inputblue" style="width: 130px" id="start_date_end"
        ...
        <tr>
                   <th class="style29">
                        离场时间</th>
                    <td class="style29">
                        <input type="text" class="inputblue" style="width: 130px" id="end_date_begin"
                            runat="server" onfocus="setdatetime(this)" vdisp="起始时间" vtype="datetime" name="end_date_begin"
                            maxlength="20" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})" />～<input type="text" class="inputblue" style="width: 130px" id="end_date_end"
                                runat="server" onfocus="setdatetime(this)" vdisp="截止时间" 
                            vtype="datetime" name="end_date_end"
                                maxlength="20" onclick="laydate({istime: true, format: &#39;YYYY-MM-DD hh:mm:ss&#39;})" /><input id="cbToday_out" runat="server" 
                            name="cbToday_out" type="checkbox" />今天</td>
        </tr>
