<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rp_ticket_sendlist.aspx.cs" Inherits="ReportViewer_Business_rp_ticket_sendlist" %>
...
<body>
   ...
   <tr>
                ...
                <td class="style29">
                    <input type="text" class="inputblue" style="width: 120px" id="receiverid" runat="server"
            ...
            <tr>
                ...
                <td class="style29"> 
                    <input type="text" class="inputblue" style="width: 120px" id="receivername" runat="server"
            ...
            <tr>
                ...
                <td class="style29">
                    <select class="inputblue" style="width: 100px" id="agentid" runat="server" name="Status">
                    </select></td>
            </tr>
            <tr>
