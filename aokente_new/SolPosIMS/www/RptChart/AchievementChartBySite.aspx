<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AchievementChartBySite.aspx.cs" Inherits="RptChart_AchievementChartBySite" StylesheetTheme="app"%>
...
<style type="text/css">
    ...
    { width:80px; color:#000;}
      .checkitall a
    {color:Red; cursor:pointer; width:20px; }	
...
<body style="width: 98%;" bgcolor="#999999" >
 ...
 <tr>
                    ...
                    <div class="inline layinput"  style="float:left;margin-left:1px; border:1px solid #B8E1F6; width:155px; height:25px;"><input id="operatorid" runat="server" style="width:130px;height:25px; font-size:8pt;"  value="请输入路段编号" onclick="javascript:this.value=''" /></div></td>
                </tr>
                <tr>
        ...
        <div class="appsection" id="search_result" runat="server">
            <div class="apphead">
                <img src="../images/bullet02.gif" class="appfollowimg" alt="" /><strong>营收统计信息</strong></div>
             <div id="container">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="pageSize"
            OnSelecting="ObjectDataSource1_Selecting" SelectCountMethod="GetObjectsCount_site_statistics"
            SelectMethod="GetPagedObjects_site_statistics" SortParameterName="sortedBy" StartRowIndexParameterName="startIndex"
            TypeName="Ims.Site.BLL.AchievementChartBySiteBLL" OldValuesParameterFormatString="">
            <SelectParameters>
