<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepeaterList.aspx.cs" Inherits="ST_RepeaterList" StylesheetTheme="app" %>
...
<ul class="sitemappath"><li><strong>中继器基本信息</strong></li></ul>
...
<div class="appsection" id="search_result" runat="server" >
	<div class="apphead"><img src="../images/bullet02.gif" class="appfollowimg" alt=""/><strong>中继器信息</strong></div>
    <asp:GridView Width="100%" PageSize="20" ID="GridView1" runat="server" 
        ...
        <Columns>
           <asp:TemplateField HeaderText="设备地址(MAC)">
            ...
            <asp:BoundField DataField="updateTime" HeaderText="更新时间戳" Visible="false"  >
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            ...
            <asp:BoundField DataField="createTime" HeaderText="创建时间戳" Visible="false" >
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
           ...
           <asp:BoundField DataField="deviceType" HeaderText="设备类型" HtmlEncode="False" >
            ...
            <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    <a href="MagicList.aspx?fID=<%# Eval("mac")%>"><span style="color:orange">[子设备列表]</span></a>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
...
<div class="table_data_title xytact">
    ...
    OnSelecting="ObjectDataSource1_Selecting" SelectCountMethod="GetObjectsCount_Repeater" 
    SelectMethod="GetPagedObjects_Repeater" SortParameterName="sortedBy" 
