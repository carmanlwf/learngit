...
var Dialog = function() {
    ...
    if (!this.ID && topWin.Dialog != "undefined")
        this.ID = "";
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif) repeat-y right;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-image:url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif);"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'wbox.gif)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn1.gif)\'" style="margin-top:5px; position: relative; cursor: pointer; float: right; height: 17px; width: 28px; background-image: url(' + IMAGESPATH + 'dialog_closebtn2.gif);' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif)  repeat-y left;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif) repeat-y right;"></td>\
	...
	' + (function (obj) {
      ...
      <td width="13" style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif) repeat-y left; "></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif) no-repeat top right;"></td>\
      <td style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif) repeat-x top;"></td>\
      <td width="13" height="13" style="background-image: url(' + IMAGESPATH + 'wbox.gif) !important;background: url(' + IMAGESPATH + 'wbox.gif) no-repeat top left;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
