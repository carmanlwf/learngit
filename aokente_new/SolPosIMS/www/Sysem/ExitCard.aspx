<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExitCard.aspx.cs" Inherits="Sysem_ExitCard"
    StylesheetTheme="app" %>
...
<body style="width: 98%;">
    ...
    <div class="appsection">
        <table cellpadding="1" cellspacing="1" class="table_default table_blue" style="width: 100%">
            <tr>
                ...
                <td colspan="3">
                    &nbsp;<input type="text" class="inputblue" style="width: 130px" id="OperateDate1"
                        runat="server" onfocus="setdatetime(this)" vdisp="起始时间" vtype="date" name="OperateDate1"
                        maxlength="20" />～<input type="text" class="inputblue" style="width: 130px" id="OperateDate2"
                            runat="server" onfocus="setdatetime(this)" vdisp="截止时间" vtype="date" name="OperateDate2"
                            maxlength="20" />
                </td>
                <td>
                </td>
    ...
    <div class="appsection" id="search_result" runat="server">
        <div class="apphead">
            <img src="../images/bullet02.gif" class="appfollowimg" alt="" /><strong>退卡记录信息</strong></div>
        <asp:GridView Width="100%" PageSize="20" ID="GridView1" runat="server" SkinID="GridView_Blue"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Chargetype" HeaderText="交易类型">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="amount" HeaderText="扣款金额">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="logtime" HeaderText="扣款时间">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="chargeway" HeaderText="扣款方式">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="operid" HeaderText="营业员">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
