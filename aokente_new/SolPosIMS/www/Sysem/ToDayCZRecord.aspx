<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ToDayCZRecord.aspx.cs" Inherits="Sysem_ToDayCZRecord" StylesheetTheme="app" %>
...
<body style="width: 98%;">
    ...
    <ul class="sitemappath">
        <li><strong>每日充值记录信息</strong></li></ul>
    ...
    <div class="appsection" id="search_result" runat="server">
        <div class="apphead">
            <img src="../images/bullet02.gif" class="appfollowimg" alt="" /><strong>每日充值记录信息</strong></div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" MaximumRowsParameterName="pageSize"
        ...
        <SelectParameters>
            <asp:Parameter Name="o" Type="Object" />
                    ...
                    <div id="SumPan"  runat = "server" style="width: 500px; display:block;" >
                    <%--交易总额:<asp:Label ID="Label1" runat="server" ForeColor="#C00000">0.00</asp:Label>&nbsp;&nbsp;
                    交易数量:<asp:Label ID="Label2" runat="server" ForeColor="#C00000">0</asp:Label>&nbsp;&nbsp;--%>
